--[[
This module implements the parser for Titan description files.
]]
...
local tllexer = require "titan-lang.tllexer"
local tltype = require "titan-lang.tltype"

local G = lpeg.P { "TitanDescription";
  TitanDescription = tllexer.Skip * lpeg.V("DescriptionList") * -1 +
