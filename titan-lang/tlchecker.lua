--[[
This file implements Titan type checker
]]
...
local tlst = require "titan-lang.tlst"
local tltype = require "titan-lang.tltype"
local tlparser = require "titan-lang.tlparser"
local tldparser = require "titan-lang.tldparser"
local tlfilter = require "titan-lang.tlfilter"
...
local function load_lua_env (env)
  local path = "titan-lang/"
  local l = {}
  if _VERSION == "Lua 5.3" then
    path = path .. "lib/"
    l = { "coroutine", "package", "string", "utf8", "table", "math", "io", "os", "debug" }
  else
    error("Titan does not support " .. _VERSION)
  end
