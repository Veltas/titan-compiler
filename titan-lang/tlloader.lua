--[[
This file implements a Titan module loader
]]
...
-------------------------------------------------------------------------------
-- Titan counterparts of Lua's load functions
-------------------------------------------------------------------------------

function tlloader.loadstring (string, chunkname, ...)
  chunkname = chunkname or "=(titan-lang.loadstring)"
...
tlloader.load     = create_load    (tlloader.loadstring, "=(titan-lang.load)")
...
-- which decides whether the string is Titan or plain Lua based on the
-- chunk name: the ".tl" extension is linked to Titan 
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
-- Insert / remove the Titan loader.
-------------------------------------------------------------------------------
